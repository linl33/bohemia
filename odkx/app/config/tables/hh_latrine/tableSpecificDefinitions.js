window.odkTableSpecificDefinitions = {
  "_tokens": {
    ...
    "4aciii": {
      "string_token": "4aciii",
      "text": {
        "default": "41c (iii). [If yes] With how many households? (not including this household",
        "pt": "41c (iii). [Se sim] Com quantos agregados familiares? (Não incluindo este agregado familiar",
        "sw": "41c (iii). [Ikiwa ndiyo] Na kaya ngapi? (bila kujumuisha kaya hii"
      },
      "_row_num": 4
    },
    "hh_id_note": {
