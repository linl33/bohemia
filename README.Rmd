...
1. Download Mozambique data from https://download.geofabrik.de/africa/mozambique-latest-free.shp.zip into `data-raw/geofabrik`

2. Download Tanzania data from https://download.geofabrik.de/africa/tanzania-latest-free.shp.zip into `data-raw/geofabrik`
