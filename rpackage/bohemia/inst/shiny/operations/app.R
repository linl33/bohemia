    ...
    tabItem(
      ...
      fluidPage(
        fluidRow(column(4, 
                        ...
                        sliderInput('humans_per_household', 'Humans per household',
                        ...
                        sliderInput('minimum_humans', 'Minimum number of humans per cluster',
                                    min = 0, max = 100,
                                    value = 0, step = 5),
                        sliderInput('minimum_households', 'Minimum number of households per cluster',
                                    min = 0, max = 500,
                                    value = 0, step = 5),
                 ...
                 column(8, align = 'center',
                        helpText('Once you are satisfied with the parameters at left, click the "Generate clusters!" button below. Note that this can take 1-5 minutes.'),
                        actionButton('action_cluster', 'Generate clusters!'),
                        h3(textOutput('cluster_summary_text')),
  ...
  observeEvent(input$action_cluster, {
    ...
    withCallingHandlers({
      ...
      out <- try_clusters(the_country = input$clustering_country,
                          km = input$km,
                          max_km_from_hq = input$max_km_from_hq,
