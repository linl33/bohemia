#' Update va data in the bohemia database
#' 
#' Take the formatted va data (as generated by "format_va") and update the data in the database
#' @param formatted_data A list of dataframes (just one actually) as generated by format_va
...
update_va <- function(formatted_data,
                              con = NULL,
                              host = NULL,
                              user = NULL,
                              pass = NULL,
