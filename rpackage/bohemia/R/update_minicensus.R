#' Update minicensus data in the bohemia database
#' 
#' Take the formatted minicensus data (as generated by "format_minicensus") and update the data in the database
#' @param formatted_data A list of dataframes as generated by format_minicensus
