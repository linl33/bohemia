#' Update enumerations data in the bohemia database
#' 
#' Take the formatted enumerations data (as generated by "format_enumerations") and update the data in the database
#' @param formatted_data A list of dataframes (just one actually) as generated by format_enumerations
